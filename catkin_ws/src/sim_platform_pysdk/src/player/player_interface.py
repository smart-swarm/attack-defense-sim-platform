...
class PlayerInterface(object):
    ...
    def __new__(cls, *args, **kwargs):
        if not PlayerInterface._instance:
            PlayerInterface._instance = super(PlayerInterface, cls).__new__(cls, *args, **kwargs)
        return PlayerInterface._instance
    ...
    def __init__(self):
        ...
        self.__pub_move_cmd = rospy.Publisher('/A/move_cmd', Move_cmd, queue_size=10)
        self.__pub_attack_cmd = rospy.Publisher('/A/attack_cmd', Attack_cmd, queue_size=10)
